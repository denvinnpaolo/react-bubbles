...
Token is used as a payload in order to authenticate a login inputed by the user.

- [ ] What steps can you take in your web apps to keep your data secure?
Use a private router that NEEDS a token/cookie to be able to access a protected page

- [ ] Describe how web servers work.
The web server works by having the web browser request for a specific file in a file system. In this process, the browser relies on the server to retrieve the data from the file system. 
